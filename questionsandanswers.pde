...
for (int r=0; r<otherArray.length;r++){
  otherArray[r]=int(random(10));
  println("otherArray at position"+ r + " is: " +otherArray[r]);
}

for (int z=0;z<lastArray.length;z++){
lastArray[z]=int(random(100));
println("lastArray at position" + z + " is: " + lastArray[z]);}